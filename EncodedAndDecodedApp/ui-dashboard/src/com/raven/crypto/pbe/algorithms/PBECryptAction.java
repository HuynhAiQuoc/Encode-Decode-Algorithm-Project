package com.raven.crypto.pbe.algorithms;
...
import com.raven.crypt.pbe.dialog.dialogReEnter;

public class PBECryptAction extends SwingWorker<Integer, String>
{
    DateFormat objDateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
    Date objDate = new Date();
    
    PBEAlgorithms objUtility = new PBEAlgorithms();
    ...
    public PBECryptAction(String strArgMessageDigestAlgorithm, int intArgPasswordHashIteration, String strArgPassword, String strArgCryptAction, boolean boolArgOriginalFileDelete, String strArgCryptExtension, StringBuilder strArgBuilderMessage, JTable objArgJTable, JProgressBar objArgJProgressBar)
    {
